...
function showError(elementId, message, isError = true) {
    ...
    if (errorElement) {
        ...
        errorElement.className = isError ? 'message error' : 'message';
...
// Debug: Log that main.js has loaded
console.log('main.js loaded successfully - apiCall, showError, and showMessage are available');
